<template>
  <div class="nft-navigation-change-lang">
    <div class="changeLangBtn" @click="displayLangMenu">
      <h6 class="changeLangBtnValue desktop greenText">
        {{this.$i18n.locale.toUpperCase()}}
      </h6>
      <img class="mobile" :src="'assets/images/flags/flag' + this.$i18n.locale.toUpperCase() + '.svg'" alt="">
...
<!--        <h6>{{index.toUpperCase()}}</h6>-->
        <img :src="'assets/images/flags/flag' + index.toUpperCase() + '.svg'" alt="">
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changeLang(elem) {
      this.pageLang = elem.currentTarget.lastChild.src.slice(-6, -4).toLowerCase()
    }
  },
  watch: {
